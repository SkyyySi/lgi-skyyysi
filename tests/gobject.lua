...
function gobject.subclass_prop1()
	...
	Derived._property.string = GObject.ParamSpecString("string", "Nick string", "Blurb string", "string-default", { "READABLE", "WRITABLE", "CONSTRUCT" })
	local der = Derived()
...
function gobject.subclass_prop_inherit()
	local GObject = lgi.GObject
	local Gio = lgi.Gio
	local FakeMonitor = GObject.Object:derive("LgiTestFakeMonitor1", { Gio.Initable, Gio.NetworkMonitor })
	FakeMonitor._property.network_available = GObject.ParamSpecBoolean("network-available", "LgiTestFakeMonitor1NetworkAvailable", "Whether the network is available.", false, { GObject.ParamFlags.READABLE })
	FakeMonitor._property.network_metered = GObject.ParamSpecBoolean("network-metered", "LgiTestFakeMonitor1NetworkMetered", "Whether the network is metered.", false, { GObject.ParamFlags.READABLE })
	FakeMonitor._property.connectivity = GObject.ParamSpecEnum("connectivity", "LgiTestFakeMonitor1Connectivity", "Type of connectivity.", Gio.NetworkConnectivity, Gio.NetworkConnectivity.LOCAL, { GObject.ParamFlags.READABLE })
...
function gobject.subclass_prop_getset()
	...
	Derived._property.str = GObject.ParamSpecString("str", "Nick string", "Blurb string", "string-default", { "READABLE", "WRITABLE", "CONSTRUCT" })
	local propval
