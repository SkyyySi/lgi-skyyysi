...
/* Marshalls single value from Lua to GLib/C. Returns number of temporary
   ...
   returns. */
int lgi_marshal_2c(lua_State *L, GITypeInfo *ti, GIArgInfo *ai, GITransfer xfer, gpointer target, int narg, int parent, GICallableInfo *ci, void **args);
...
gboolean lgi_marshal_2c_caller_alloc(lua_State *L, GITypeInfo *ti, GIArgument *target, int pos);
...
/* Marshalls single value from GLib/C to Lua. If parent is non-0, it
   ...
   resides. */
void lgi_marshal_2lua(lua_State *L, GITypeInfo *ti, GIArgInfo *ai, GIDirection dir, GITransfer xfer, gpointer source, int parent, GICallableInfo *ci, void *args);
...
void lgi_record_2c(lua_State *L, gint narg, gpointer target, gboolean by_value, gboolean own, gboolean optional, gboolean nothrow);
