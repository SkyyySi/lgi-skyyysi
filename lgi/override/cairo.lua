...
local assert, pairs, ipairs, setmetatable, table, rawget, type = assert, pairs, ipairs, setmetatable, table, rawget, type
...
for _, name in pairs {
	...
	local gtype = ffi.load_gtype(module_gobject, "cairo_gobject_" .. core.uncamel(name) .. "_get_type")
	if gtype then
...
cairo.version = core.callable.new {
	addr = cairo._module.cairo_version,
	ret = ti.int,
}()
cairo.version_string = core.callable.new {
	addr = cairo._module.cairo_version_string,
	ret = ti.utf8,
}()
...
for index, struct in pairs {
	...
	if cairo.version >= since then
		local gtype = ffi.load_gtype(module_gobject, "cairo_gobject_" .. core.uncamel(struct) .. "_get_type")
...
ffi.load_fields(path_data_header, { { "type", cairo.PathDataType }, { "length", ti.int } })
...
for _, info in ipairs {
	...
	{ "Matrix", fields = {
		...
		init = { ti.double, ti.double, ti.double, ti.double, ti.double, ti.double },
		init_identity = {},
		...
		transform_distance = { { ti.double, dir = "inout" }, { ti.double, dir = "inout" } },
		transform_point = { { ti.double, dir = "inout" }, { ti.double, dir = "inout" } },
	} },
...

	{
		...
		cprefix = "",
		methods = {
			create = { static = true, ret = { cairo.Context, xfer = true }, cairo.Surface },
			...
			clip = {},
			clip_preserve = {},
			clip_extents = { { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			...
			fill = {},
			fill_preserve = {},
			fill_extents = { { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			...
			stroke = {},
			stroke_preserve = {},
			stroke_extents = { { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			...
			get_current_point = { { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			new_path = {},
			new_sub_path = {},
			close_path = {},
			arc = { ti.double, ti.double, ti.double, ti.double, ti.double },
			arc_negative = { ti.double, ti.double, ti.double, ti.double, ti.double },
			...
			-- glyph_path,
			text_path = { ti.utf8 },
			rel_curve_to = { ti.double, ti.double, ti.double, ti.double, ti.double, ti.double },
			rel_line_to = { ti.double, ti.double },
			rel_move_to = { ti.double, ti.double },
			path_extents = { { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			...
			identity_matrix = {},
			user_to_device = { { ti.double, dir = "inout" }, { ti.double, dir = "inout" } },
			user_to_device_distance = { { ti.double, dir = "inout" }, { ti.double, dir = "inout" } },
			device_to_user = { { ti.double, dir = "inout" }, { ti.double, dir = "inout" } },
			device_to_user_distance = { { ti.double, dir = "inout" }, { ti.double, dir = "inout" } },
	...
	{ "SolidPattern", parent = cairo.Pattern, cprefix = "pattern_", methods = {
		create_rgb = { static = true, ret = { cairo.Pattern, xfer = true }, ti.double, ti.double, ti.double },
		create_rgba = { static = true, ret = { cairo.Pattern, xfer = true }, ti.double, ti.double, ti.double, ti.double },
		get_rgba = { ret = cairo.Status, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
	} },

	{ "SurfacePattern", parent = cairo.Pattern, cprefix = "pattern_", methods = {
		create = {
			cname = "cairo_pattern_create_for_surface",
			static = true,
	...
	{ "GradientPattern", parent = cairo.Pattern, cprefix = "pattern_", methods = {
		add_color_stop_rgb = { ti.double, ti.double, ti.double, ti.double },
		add_color_stop_rgba = { ti.double, ti.double, ti.double, ti.double, ti.double },
		get_color_stop_count = { ret = cairo.Status, { ti.int, dir = "out" } },
		get_color_stop_rgba = { ret = cairo.Status, ti.int, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
	} },

	{ "LinearPattern", parent = cairo.GradientPattern, cprefix = "pattern_", methods = {
		create = { cname = "cairo_pattern_create_linear", static = true, ret = { cairo.Pattern, xfer = true }, ti.double, ti.double, ti.double, ti.double },
		get_linear_points = { ret = cairo.Status, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
	} },

	{ "RadialPattern", parent = cairo.GradientPattern, cprefix = "pattern_", methods = {
		create = { cname = "cairo_pattern_create_radial", static = true, ret = { cairo.Pattern, xfer = true }, ti.double, ti.double, ti.double, ti.double, ti.double, ti.double },
		get_radial_circles = { ret = cairo.Status, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
	} },

	{ "MeshPattern", parent = cairo.Pattern, since = cairo.version_encode(1, 12, 0), methods = {
		create = { cname = "cairo_pattern_create_mesh", static = true, ret = { cairo.Pattern, xfer = true } },
		begin_patch = {},
		end_patch = {},
		move_to = { ti.double, ti.double },
		line_to = { ti.double, ti.double },
		...
		get_control_point = { ret = cairo.Status, ti.int, ti.int, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
		get_corner_color_rgba = { ret = cairo.Status, ti.int, ti.int, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" }, { ti.double, dir = "out" } },
	} },
...

	{
		"Surface",
		methods = {
			create_similar = { ret = { cairo.Surface, xfer = true }, cairo.Content, ti.int, ti.int },
			create_similar_image = { since = cairo.version_encode(1, 12, 0), ret = { cairo.Surface, xfer = true }, cairo.Format, ti.int, ti.int },
			create_for_rectangle = { ret = { cairo.Surface, xfer = true }, ti.double, ti.double, ti.double, ti.double },
			status = { ret = cairo.Status },
			finish = {},
			flush = {},
			...
			get_device_offset = { { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			set_device_scale = { since = cairo.version_encode(1, 14, 0), ti.double, ti.double },
			get_device_scale = { since = cairo.version_encode(1, 14, 0), { ti.double, dir = "out" }, { ti.double, dir = "out" } },
			set_fallback_resolution = { ti.double, ti.double },
			get_fallback_resolution = { { ti.double, dir = "out" }, { ti.double, dir = "out" } },
	...
	{ "ImageSurface", parent = cairo.Surface, methods = {
		create = { static = true, ret = { cairo.Surface, xfer = true }, cairo.Format, ti.int, ti.int },
		create_for_data = { static = true, ret = { cairo.Surface, xfer = true }, ti.ptr, cairo.Format, ti.int, ti.int, ti.int },
		create_from_png = { static = true, ret = { cairo.Surface, xfer = true }, ti.filename },
		get_data = { ret = ti.ptr },
	...
	{ "PdfSurface", parent = cairo.Surface, methods = {
		create = { static = true, ret = { cairo.Surface, xfer = true }, ti.filename, ti.double, ti.double },
	...
	{ "PsSurface", parent = cairo.Surface, methods = {
		create = { static = true, ret = { cairo.Surface, xfer = true }, ti.filename, ti.double, ti.double },
	...
	{ "RecordingSurface", parent = cairo.Surface, methods = {
		create = { static = true, ret = { cairo.Surface, xfer = true }, cairo.Content, cairo.Rectangle },
		ink_extents = {
			{ ti.double, dir = "out" },
			{ ti.double, dir = "out" },
			{ ti.double, dir = "out" },
		...
		get_extents = { since = cairo.version_encode(1, 12, 0), ret = ti.boolean, cairo.Rectangle },
	} },
	...
	{ "SvgSurface", parent = cairo.Surface, methods = {
		create = { static = true, ret = { cairo.Surface, xfer = true }, ti.filename, ti.double, ti.double },
	...
	{ "ToyFontFace", parent = cairo.FontFace, methods = {
		create = { static = true, ret = { cairo.ToyFontFace, xfer = true }, ti.utf8, cairo.FontSlant, cairo.FontWeight },
	...
	}, properties = { "status", "antialias", "subpixel_order", "hint_style", "hint_metrics" } },

	{
		"ScaledFont",
		methods = {
			create = { static = true, ret = { cairo.ScaledFont, xfer = true }, cairo.FontFace, cairo.Matrix, cairo.Matrix, cairo.FontOptions },
			status = { ret = cairo.Status },
	...
	{ "Region", methods = {
		...
		create_rectangle = { static = true, ret = { cairo.Region, xfer = true }, cairo.RectangleInt },
		...
		if info.methods then
			...
			for method_name, method_info in pairs(info.methods) do
				if cairo.version >= (method_info.since or 0) then
					...
					method_info.addr = assert(cairo._module[method_info.cname or (cprefix .. method_name)])
...
local raw_set_dash = core.callable.new {
	addr = cairo._module.cairo_set_dash,
	ret = ti.void,
	cairo.Context,
	wrapped_double,
	ti.int,
...
local raw_get_dash = core.callable.new {
	addr = cairo._module.cairo_get_dash,
	ret = ti.void,
	cairo.Context,
	wrapped_double,
	{ ti.double, dir = "out" },
