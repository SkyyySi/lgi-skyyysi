...
local assert, require, pcall, setmetatable, pairs, type, error, tostring, _VERSION, jit = assert, require, pcall, setmetatable, pairs, type, error, tostring, _VERSION, rawget(_G, "jit")
