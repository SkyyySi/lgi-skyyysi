return function(parent, dir)
	...
	local function start_search()
		...
		search_progress_id = GLib.timeout_add_seconds(GLib.PRIORITY_DEFAULT, 1, function()
			search_progress_id = GLib.timeout_add(GLib.PRIORITY_DEFAULT, 100, function()
				entry:progress_pulse()
				return true
			end)
			return false
		end)
		finish_search_id = GLib.timeout_add_seconds(GLib.PRIORITY_DEFAULT, 15, finish_search)
	end
