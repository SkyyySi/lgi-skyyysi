...
timer:reset()
for i = 1, count do
	Gio.Async.call(perform)(read_async, write_async, Gio.File.new_for_path("test-async-" .. i))
end
...
function app:on_activate()
	for i = 1, count do
		Gio.Async.start(perform)(read_async, write_async, Gio.File.new_for_path("test-parallel-" .. i))
	end
end
timer:reset()
app:run(...)
